...
--
-- Servidor: localhost
-- Tiempo de generación: 13-07-2013 a las 04:34:56
...
INSERT INTO `abogados` (`AbgId`, `AbgNombre`, `AbgTelefono`, `AbgCorreo`, `AbgTargeta`, `AbgFoto`, `AbgPerfil`) VALUES
(1, 'Diego', 2147483647, 'juln@gmail.com', '17955', 'dafasfas', 'ddsfasf');
...
CREATE TABLE IF NOT EXISTS `archivo` (
  ...
  `AchUrl` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`AchId`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=2 ;
...
INSERT INTO `archivo` (`AchId`, `AchNombre`, `AchDescripcion`, `AchUrl`) VALUES
(1, 'Coso', '\r\n      programando no molestar', '/img/archivos/fba758_perro.jpg');
...
INSERT INTO `beneficiario` (`BenId`, `BenCedula`, `BenCorreo`, `BenNombre`, `BenTelefono`) VALUES
(12, '1111', 'anjuom@hotmail.com', 'Roverto', '33124123');
...
--
-- Volcado de datos para la tabla `beneficiarioarchivo`
--

INSERT INTO `beneficiarioarchivo` (`BenId`, `AchId`) VALUES
(12, 1),
(12, 1),
(12, 1);
...
(2, 'Jorge Edwin', 'jorgedipra@gmail.com', '123', 23, 'jorgedipara', 2, 'jul_Ort@hotmail.com');
